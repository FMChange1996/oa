...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="{{url('home/index')}}">后台管理系统 V1.0</a></div>
    <div class="left_open">
    ...
    <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
        ...
        <div class="layui-tab-content">
            <div class="layui-tab-item layui-show">
                <iframe src='{{url('home/'.$url)}}' frameborder="0" scrolling="yes" class="x-iframe"></iframe>
            </div>
        </div>
    </div>
</div>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright">Copyright ©2017 Brook All Rights Reserved</div>
</div>
<!-- 底部结束 -->
</body>
</html>